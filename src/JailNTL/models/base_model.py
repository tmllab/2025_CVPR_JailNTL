...
class BaseModel(ABC):
    ...
    def __init__(self, opt, task_name):
        ...
        self.save_dir = os.path.join(opt.checkpoints_dir, task_name)  # save all the checkpoints to save_dir
        torch.backends.cudnn.benchmark = True  # set to True to speed up
        self.loss_names = []
        self.model_names = []
        self.visual_names = []
        self.optimizers = []
